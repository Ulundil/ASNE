...
class SNE(BaseEstimator, TransformerMixin):
    def __init__(self, data, id_embedding_size, attr_embedding_size,
        ...
        self.node_neighbors_map = dict([key, list(value)] for key, value in data.node_neighbors_map.items())
        print(type(self.node_neighbors_map))
        print(type(self.node_neighbors_map[0]))
    ...
    def _init_graph(self):
        ...
        with self.graph.as_default():#, tf.device('/cpu:0'):
            ...
            print(self.loss)
            print(self.weights['out_embeddings'])
            # Optimizer.
    ...
    def train(self): # fit a dataset
        ...
        print(type(self.node_neighbors_map))
        with open('node_neighbors_map.json', 'w') as fp:
            json.dump(self.node_neighbors_map, fp, indent = 4)
